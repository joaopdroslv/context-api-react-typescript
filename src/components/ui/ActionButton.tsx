...
const colorClasses: Record<ActionButtonColor, string> = {
  default:
    "text-purple-700 border border-purple-700 hover:bg-purple-800 hover:text-white dark:border-purple-500 dark:text-purple-500 dark:hover:bg-purple-500 dark:hover:text-white",
  ...
  blue: "text-blue-700 border border-blue-700 hover:bg-blue-800 hover:text-white dark:border-blue-400 dark:text-blue-400 dark:hover:bg-blue-500 dark:hover:text-white",
};
